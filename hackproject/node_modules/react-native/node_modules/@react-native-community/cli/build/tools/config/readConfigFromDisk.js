...
function readLegacyDependencyConfigFromDisk(rootFolder) {
  ...
  _cliTools().logger.warn(`Package "${_chalk().default.bold(_path().default.basename(name))}" is using deprecated "rnpm" config that will stop working from next release. Please notify its maintainers about it.`);
