...
var _resolveNodeModuleDir = _interopRequireDefault(require("./tools/config/resolveNodeModuleDir"));

var _getLatestRelease = _interopRequireDefault(require("./tools/releaseChecker/getLatestRelease"));

var _printNewRelease = _interopRequireDefault(require("./tools/releaseChecker/printNewRelease"));
...
async function checkForNewRelease(root) {
  try {
    const {
